...
void strassen_aux_improved(float **C, const size_t C_f_row, const size_t C_f_col,
                  float **A, const size_t A_f_row, const size_t A_f_col,
                  float **B, const size_t B_f_row, const size_t B_f_col,
 		  float **M, const size_t M_f_row, const size_t M_f_col, //added an auxiliary matrix
                  const size_t n)

{
  ...
  /*
  I will use the (M2X,MX2) submatrix as the auxiliary matrix to pass recursively.
  The other 3 submatrices (M1X,MX1), (M1X,MX2), (M2X,MX1) are the auxiliary matrices used to store
  the temporary matrices Pi and Si.
  I also exploited some temporary unused submatrices of C to store Pi and Si.
  */
